(function() {
    ...
    var app = {
        ...
        bind: function() {
            ...
            $(".add-music-demo").on('click', function() {
                $('.music-demo-file').click();
            });

            $(".music-demo-list").on("click", "li", function() {
                var index = $(".music-demo-list li").index($(this));
                that.trigger(index);
            });

            //如果用户选取了自己的音乐则通过filereader读取
            $('.music-demo-file').on('change', function() {
                ...
                files.forEach(function(file) {
                    ...
                    fr.onload = function(e) {
                        decodeBuffer(e.target.result, function(buffer) {
                            ...
                            $(".music-demo-list li").eq(musics.indexOf(mdata)).html(mdata.name);
                        })
                    };
                });
        ...
        trigger: function(index) {
            ...
            $(".music-demo-list li").eq(index).addClass("playing").siblings().removeClass("playing");
        ...
        render: function(musics) {
            ...
            $(".music-demo-list").html(html);
            $(".music-demo-list li").eq(nowIndex).addClass("playing");
        }
    };
